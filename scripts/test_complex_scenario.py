...
def run_test():
    ...
    transcript = [
        ...
        {"speaker": "agent", "text": "၅ ဘူးဆိုရင် Combo 5 ပါရှင်။ စုစုပေါင်း ၄ သိန်း ၅ သောင်းကျပ်ပဲ ကျသင့်မှာပါရှင်။ ပို့ခအခမဲ့ပါရှင်။"},
        {"speaker": "customer", "text": "ကွန်ဘို ၅ က တအားများတယ်။ ကွန်ဘို ၃ ယူမယ်။ မဟုတ်ဘူး၊ စဉ်းစားဦးမယ်... ကွန်ဘို ၃ မှာ ၃ ဘူးပါတယ်။ စျေးက ၃ သိန်းနော်။ ဟုတ်လား။"},
        {"speaker": "agent", "text": "ဟုတ်ကဲ့ပါရှင်။ Combo 3 က ၃ ဘူးပါပြီး စျေးနှုန်းကတော့ ၃ သိန်းကျပ်ပါရှင်။"},
        ...
        {"speaker": "agent", "text": "ဟုတ်ကဲ့ပါရှင်။ ဖုန်း ၀၉၇၈၄၄၃၃၅၅၆၊ ပို့ရမယ့်လိပ်စာကတော့ ရန်ကုန်၊ ကမာရွတ်၊ လှည်းတန်းလမ်း၊ အမှတ် ၁၂၃၊ ဒုတိယထပ်၊ မှာယူတဲ့ပစ္စည်းက Combo 3 (၃ ဘူး)၊ စုစုပေါင်း ကျသင့်ငွေ ၃ သိန်းကျပ်ပါရှင်။ ဟုတ်ပါသလားရှင်။"},
